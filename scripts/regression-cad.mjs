...
project.settings={...project.settings,useDeckBoards:true,deckBridgeGap:150}
...
if(JSON.stringify(types)!==JSON.stringify(['40STD','40STD','20STD'])||result.unpacked.length!==0||!valid){
