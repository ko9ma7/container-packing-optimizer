...
export const sampleCargo = [
  { id:'machine', name:'산업용 장비', length:1800, width:1200, height:1500, weightKg:420, quantity:2, rotation:'upright', stackable:false, canBeNested:false, color:'#1f8ef1', packaging:pkg('woodBlocking',{addLength:140,addWidth:140,addHeight:100,tareWeightKg:32}), innerSpace:{ enabled:false, length:0, width:0, height:0, access:'full', maxPayloadKg:0 } },
  { id:'tank-open', name:'상부 개방 탱크', length:1800, width:1200, height:1200, weightKg:180, quantity:2, rotation:'upright', stackable:false, canBeNested:false, color:'#11a29b', packaging:pkg('woodSkid',{addLength:80,addWidth:80,addHeight:100,tareWeightKg:28}), innerSpace:{ enabled:true, length:1500, width:900, height:820, access:'top', maxPayloadKg:700 } },
  { id:'box-a', name:'부품 박스 A', length:600, width:400, height:350, weightKg:12, quantity:18, rotation:'free', stackable:true, canBeNested:true, color:'#4f7cff', packaging:pkg('bare'), innerSpace:{ enabled:false, length:0, width:0, height:0, access:'full' } },
  { id:'box-b', name:'부품 박스 B', length:450, width:300, height:250, weightKg:6, quantity:40, rotation:'free', stackable:true, canBeNested:true, color:'#f2b84b', packaging:pkg('bare'), innerSpace:{ enabled:false, length:0, width:0, height:0, access:'full' } },
  { id:'pallet-crate', name:'팔레트 크레이트', length:1100, width:900, height:1000, weightKg:250, quantity:4, rotation:'upright', stackable:true, canBeNested:false, color:'#7b61ff', packaging:pkg('woodCrate',{addLength:0,addWidth:0,addHeight:0,tareWeightKg:0}), innerSpace:{ enabled:false, length:0, width:0, height:0, access:'full' } },
]
