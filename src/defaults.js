...
export const sampleCargo = [
  ...
  { id:'demo-insert', name:'내부 삽입 부품박스', length:420, width:300, height:240, weightKg:8, quantity:8, rotation:'locked', orientationRules:{rotate90:true,layWidth:true,layLength:true}, canBeStacked:false, canSupportCargo:false, stackable:false, maxStackLayers:1, sameCargoStackOnly:false, canBeNested:true, color:'#16a085', packaging:pkg('bare'), innerSpace:{ enabled:false, length:0, width:0, height:0, access:'full', maxPayloadKg:0 } },
]
